...
#Found this here - https://stackoverflow.com/questions/64880302/is-it-possible-to-execute-the-modified-user-data-of-an-existing-ec2-once
#The cloud-init clean will execute user data script on each run
cloud-init clean
...
<body>
	<h2>Linux Server 1</h2>
    
    <video controls autoplay muted loop width="540">
        <source src="https://class7-hw1-capeverde.s3.us-east-1.amazonaws.com/instagram_video.mp4" type="video/mp4">
        Your browser does not support the video tag.
    </video>

    <br><br>
    <img src="https://class7-hw1-capeverde.s3.us-east-1.amazonaws.com/picture1.jpg" width="400">
    <img src="https://class7-hw1-capeverde.s3.us-east-1.amazonaws.com/picture2.jpg" width="400">
    <img src="https://class7-hw1-capeverde.s3.us-east-1.amazonaws.com/picture3.jpg" width="400">
