...
<body>
	<h2>Linux Server 2</h2>
    
    <video controls autoplay muted loop width="540">
        <source src="https://class7-hw1-capeverde.s3.us-east-1.amazonaws.com/video1.mp4" type="video/mp4">
        Your browser does not support the video tag.
    </video>
    
    <video controls autoplay muted loop width="540">
        <source src="https://class7-hw1-capeverde.s3.us-east-1.amazonaws.com/video2.mp4" type="video/mp4">
        Your browser does not support the video tag.
    </video>
    
    <video controls autoplay muted loop width="540">
        <source src="https://class7-hw1-capeverde.s3.us-east-1.amazonaws.com/video3.mp4" type="video/mp4">
        Your browser does not support the video tag.
    </video>
